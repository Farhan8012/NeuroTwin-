...
- [[07 - Caregiver App]] — Caregiver management interface, feature matrix, data write path, and platform options.
...
- [[04 - Backend (FastAPI on M4)]] — Server role, REST API endpoints, async architecture, and M4 resource allocation.
...
- [[13 - Dev Environment and Tooling]] — Development loop, MCP server tools (Android-MCP, IDE plugin, Obsidian), and macOS host setup.

### Planning
- [[09 - Decisions Log]] — Architecture Decision Records (ADRs) tracking core choices and rationale.
...
| [[04 - Backend (FastAPI on M4)]] | Backend | `draft` |
| [[05 - AI Pipeline]] | AI / ML | `draft` |
| [[06 - Data Model (Qdrant Schema)]] | Data Model | `draft` |
| [[07 - Caregiver App]] | Caregiver | `draft` |
| [[08 - Tech Stack]] | Architecture | `draft` |
| [[09 - Decisions Log]] | Planning | `draft` |
| [[10 - Privacy and Ethics]] | Product / Ethics | `draft` |
| [[11 - Build Roadmap]] | Planning | `draft` |
| [[12 - Open Questions]] | Planning | `draft` |
